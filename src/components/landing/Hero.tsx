  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <div
        ...
        style={{ transition: "opacity 1.5s ease-in-out, top 1.5s ease-in-out, transform 1.5s ease-in-out" }}
      >
        <h1 
      ...
      >
        ...
        >
          <button
            ...
            className="relative inline-flex items-center justify-center px-8 py-3 font-poppins text-base font-medium text-foreground bg-background rounded-full overflow-hidden group"
          >
            <span className="absolute inset-0 rounded-full p-[2px] bg-gradient-to-r from-primary via-purple-500 to-primary bg-[length:200%_100%] animate-[border-spin_3s_linear_infinite]" style={{
